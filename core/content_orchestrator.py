...
from .ai_client import BaseAIClient, AIClientFactory
...
class ContentOrchestrator:
    ...
    def _get_client_for_model(self, model_id: str) -> BaseAIClient:
        """Crea el cliente apropiado para el modelo."""
        return AIClientFactory.create_for_model(
            model_id,
...
- Sugiere nuevas imágenes para slides sin contenido visual"""
    ...
    async def generate_from_prompt(
        ...
        # Crear cliente específico para este modelo
