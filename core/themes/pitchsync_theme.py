...
from . import ProgrammaticTheme, ThemeRegistry
...
class PitchSyncTheme(ProgrammaticTheme):
    ...
    def _setup_slide(self, engine, slide_index: int,
    ...
    def _add_header(self, engine, slide_index: int,
    ...
    def _add_card(self, engine, slide_index: int,
    ...
    def _add_tag(self, engine, slide_index: int,
                 left: float, top: float, width: float, height: float,
...
# Registro al final para evitar imports circulares
